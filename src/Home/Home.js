...
{/* 
    		...
    		<div class="row">
    			<div class="col-md-3">
    				<div class="car-wrap ftco-animate">
    					<div class="img d-flex align-items-end" style={{backgroundImage : `url(${car1})`}}>
    ...
    <section class="ftco-section services-section img" style={{backgroundImage : `url(${car1})`}}>
    	<div class="overlay"></div>
    	<div class="container">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img mb-4" style={{backgroundImage : `url(${car1})`}}>
                  </div>
                  <div class="text pt-4">
    ...
    <section class="ftco-section ftco-no-pt ftco-no-pb">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style={{backgroundImage : `url(${car1})`}}>
					</div>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style={{backgroundImage : `url(${car1})`}}>
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
